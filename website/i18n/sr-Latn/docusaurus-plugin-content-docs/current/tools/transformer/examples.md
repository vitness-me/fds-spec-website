---
title: Primeri
description: Kompletni primeri i tokovi rada za FDS Transformer
sidebar_position: 8
---
...
Transformišite jednostavan skup podataka o vežbama bez AI obogaćivanja.
...
> **Napomena:** Prikazani ID-jevi (npr. `mus.pectoralis-major`, `eq.barbell`, `cat.chest`) služe samo kao ilustracija. U produkciji pretrage registara vraćaju UUID-ove kako zahteva FDS specifikacija.

---

## Primer 2: Puno AI obogaćivanje

Transformišite uz višestepeno AI obogaćivanje za kompletne podatke o vežbama.
...
### Pokretanje sa procenom troškova
...
> **Napomena:** Prikazani ID-jevi (npr. `mus.pectoralis-major`, `eq.barbell`) služe samo kao ilustracija. U produkciji pretrage registara vraćaju UUID-ove kako zahteva FDS specifikacija.

---

## Primer 3: Paketna obrada za CI/CD

Pokrenite transformaciju u CI/CD pipeline-u sa validacijom.
...
## Primer 4: Programska upotreba

Koristite transformator kao biblioteku u svojoj Node.js aplikaciji.
...
## Primer 5: Inkrementalna ažuriranja

Nastavite veliku transformaciju nakon prekida.
...
Transformator će:
1. Učitati datoteku kontrolne tačke (`.fds-checkpoint.json`)
2. Preskočiti već obrađene vežbe
3. Nastaviti od vežbe 3.501

---

## Primer 6: Obogaćivanje jednog nivoa

Pokrenite samo određene nivoe radi testiranja ili upravljanja troškovima.
...
## Primer 7: Izlaz u jednu datoteku

Objedinite sve vežbe u jednu JSON datoteku.
